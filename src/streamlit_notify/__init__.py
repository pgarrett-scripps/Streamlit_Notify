...
def notify_all(remove: bool = True) -> None:
    ...
    Args:
        remove (bool): If True, remove notifications after displaying them.
...
def get_all_notifications() -> dict[str, list[Any]]:
    ...
    Returns:
        dict[str, list[Any]]: A dictionary mapping widget names to their
        respective notification lists.
    """
    return {
